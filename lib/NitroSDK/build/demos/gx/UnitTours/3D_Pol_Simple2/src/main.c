/*---------------------------------------------------------------------------*
  Project:  NitroSDK - GX - demos - UnitTours/3D_Pol_Simple2
  File:     main.c
  ...
  Revision 1.27  2005/11/21 10:36:23  kitase_hirotake
  SVC_WaitVBlankIntr を OS_WaitVBlankIntr に変更

  Revision 1.26  2005/02/28 05:26:15  yosizaki
  do-indent.

  Revision 1.25  2004/11/02 09:37:26  takano_makoto
  fix typo.

  Revision 1.24  2004/05/24 10:33:08  takano_makoto
  autotestコードの修正
...
//---------------------------------------------------------------------------
// A sample that uses G3_VtxXY, G3_VtxYZ, G3_VtxXZ:
// 
// You can reduce the amount of the data transferred to the FIFO
// by G3_VtxXY, G3_VtxYZ, and G3_VtxXZ.
// They can be used if one of the coordinates of the point is same
// to the previous one.
//---------------------------------------------------------------------------
