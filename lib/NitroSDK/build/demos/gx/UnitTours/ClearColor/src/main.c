/*---------------------------------------------------------------------------*
  Project:  NitroSDK - GX - demos - UnitTours/ClearColor
  File:     main.c
  ...
  Revision 1.7  2005/11/21 10:40:28  kitase_hirotake
  SVC_WaitVBlankIntr Ç OS_WaitVBlankIntr Ç…ïœçX

  Revision 1.6  2005/02/28 05:26:19  yosizaki
  do-indent.

  Revision 1.5  2004/05/27 09:25:50  takano_makoto
  Add Autotest code.
  ...
  Revision 1.2  2004/03/15 02:02:00  takano_makoto
  modify comments and codes a little.

  Revision 1.1  2004/03/01 10:39:07  terui
  initial upload
...
void NitroMain(void)
{
    ...
    while (1)
    {
        ...
        EXT_TestScreenShot(100, 0x31902242);
        EXT_TestTickCounter();
#endif //SDK_AUTOTEST
    }
}
