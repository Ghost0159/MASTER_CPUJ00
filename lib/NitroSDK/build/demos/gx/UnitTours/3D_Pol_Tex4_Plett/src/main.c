/*---------------------------------------------------------------------------*
  ...
  Revision 1.34  2005/11/21 10:37:56  kitase_hirotake
  SVC_WaitVBlankIntr を OS_WaitVBlankIntr に変更

  Revision 1.33  2005/02/28 05:26:15  yosizaki
  do-indent.

  Revision 1.32  2004/11/02 09:38:25  takano_makoto
  fix typo.

  Revision 1.31  2004/05/24 10:34:46  takano_makoto
  autotestコードの修正
...
//---------------------------------------------------------------------------
// A sample that use a texture with 4 colors texture palette:
//
// HOWTO:
...
// 3. Specify the texture to use and etc. by G3_TexImageParam(GX_TEXFMT_PLTT4, ...).
// 4. Specify the palette to use by G3_TexPlttBase(..., GX_TEXFMT_PLTT4).
...
void NitroMain(void)
{
    ...
    while (1)
    {
        ...
        EXT_TestScreenShot(100, 0x6711BF34);
        EXT_TestTickCounter();
#endif //SDK_AUTOTEST
