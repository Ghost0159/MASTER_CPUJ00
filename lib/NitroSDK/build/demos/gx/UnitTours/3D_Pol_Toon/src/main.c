/*---------------------------------------------------------------------------*
  Project:  NitroSDK - GX - demos - UnitTours/3D_Pol_Toon
  File:     main.c
  ...
  Revision 1.34  2005/11/21 10:38:46  kitase_hirotake
  SVC_WaitVBlankIntr を OS_WaitVBlankIntr に変更

  Revision 1.33  2005/02/28 05:26:18  yosizaki
  do-indent.

  Revision 1.32  2004/11/02 09:38:43  takano_makoto
  fix typo.

  Revision 1.31  2004/05/24 10:35:12  takano_makoto
  autotestコードの修正
  ...
  Revision 1.26  2004/02/05 07:09:03  yasu
  ...
  Revision 1.22  2004/01/29 07:46:50  kitani_toshikazu
  ...
  Revision 1.13  2004/01/06 12:54:09  nishida_kenji
  revise comments

  Revision 1.12  2004/01/06 00:50:37  nishida_kenji
...
void NitroMain(void)
{
    ...
    while (1)
    {
        ...
        EXT_TestScreenShot(100, 0x808ED0BD);
        EXT_TestTickCounter();
#endif //SDK_AUTOTEST
