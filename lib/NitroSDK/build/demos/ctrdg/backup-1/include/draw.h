/*---------------------------------------------------------------------------*
  ...
  $Log: draw.h,v $
  Revision 1.1  2006/04/07 03:30:29  okubata_ryoma
  backup-1サンプルデモの追加

  
  $NoKeywords: $
 *---------------------------------------------------------------------------*/
#if	!defined(NITRO_DEMOS_CTRDG_BACKUP_1_DRAW_H_)
#define NITRO_DEMOS_CTRDG_BACKUP_1_DRAW_H_
...
#endif /* NITRO_DEMOS_CTRDG_BACKUP_1_DRAW_H_ */
