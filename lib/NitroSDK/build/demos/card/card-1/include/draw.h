/*---------------------------------------------------------------------------*
  ...
  Revision 1.4  2005/02/28 05:26:06  yosizaki
  do-indent.

  Revision 1.3  2005/01/18 09:50:02  yosizaki
  copyright 年表記修正.

  Revision 1.2  2005/01/17 06:38:22  yosizaki
  フォントデータを統一.

  Revision 1.1  2004/09/09 12:50:36  yosizaki
  (none)

  $NoKeywords: $
 *---------------------------------------------------------------------------*/
#if	!defined(NITRO_DEMOS_CARD_CARD_1_DRAW_H_)
#define NITRO_DEMOS_CARD_CARD_1_DRAW_H_
...
#endif /* NITRO_DEMOS_CARD_CARD_1_DRAW_H_ */
