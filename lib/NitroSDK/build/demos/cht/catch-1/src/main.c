/*---------------------------------------------------------------------------*
  Project:  NitroSDK - CHT - demos - catch-1
  File:     main.c
  ...
  Revision 1.5  2005/11/21 10:19:21  kitase_hirotake
  OS_InitPrintServer , OS_PrintServer , PXI_Init の削除
  SVC_WaitVBlankIntr を OS_WaitVBlankIntr に変更

  Revision 1.4  2005/06/27 11:10:11  yosizaki
  add comment about DC_WaitWriteBufferEmpty().

  Revision 1.3  2005/04/26 02:35:01  terui
  Fix comment
...
/*---------------------------------------------------------------------------*
    ピクトチャットサーチ機能により、ピクトチャット親機のビーコンを検出するデモです。
 *---------------------------------------------------------------------------*/
...
#define     PICTO_CATCH_LIFETIME    300 // 5秒
