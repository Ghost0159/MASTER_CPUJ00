/*---------------------------------------------------------------------------*
  Project:  NitroSDK - MI - demos - dmaCallback-1
  File:     main.c
  ...
  Revision 1.12  2005/11/21 10:53:09  kitase_hirotake
...
void VBlankIntr(void)
{
    ...
    //---- DMA で転送。コールバックを呼ぶ
    MI_DmaCopy32Async(DMA_NO, oamBak, (void *)HW_OAM, sizeof(oamBak), myDmaCallback, (void *)0x10);
