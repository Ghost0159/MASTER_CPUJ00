/*---------------------------------------------------------------------------*
  Project:  NITRO-System - demos - g2d - Text - ShiftJISText
  File:     main.c
...
//      このデモでは NNS_G2dFontInitShiftJIS を使う場合を示しています。
...
static void SampleMain(void)
{
    ...
    NNS_G2dTextCanvasDrawText(&gTextCanvas, 0, 0,
        ...
        "\x82\xA0\x82\xA2\x82\xA4\x82\xA6\x82\xA8\x8A\xBF\x8E\x9A"  // <- 日本語文字
    );
}
