/*---------------------------------------------------------------------------*
  Project:  NITRO-System - demos - g3d - samples - VisibilityAnm
  File:     main.c
...
// ビジビリティアニメーション再生サンプル
//
// ビジビリティアニメーションを再生するには、g3dcvtrによって.ivaファイルから
// コンバートされた.nsbvaファイルを使用します。
//
// サンプルの動作
// ビジビリティアニメーションが繰り返し再生されます。
//
// HOWTO:
// 1: .nsbvaファイルをメインメモリにロードします。
// 2: NNS_G3dGetAnmByIdx, NNS_G3dGetAnmByName関数等を用いて再生したい
//    ビジビリティアニメーションへのポインタを取得します。
...
//    別のNNSG3dAnmObjを確保しなくてはいけません(.nsbvaファイル内のデータは
//    共有できます)。
//
//---------------------------------------------------------------------------
...
NitroMain(void)
{
    ...
    G3DDemo_InitConsole();
    G3DDemo_Print(0,0, G3DDEMO_COLOR_YELLOW, "VisibilityAnm");
