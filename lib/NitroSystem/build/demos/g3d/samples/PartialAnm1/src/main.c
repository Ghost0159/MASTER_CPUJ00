/*---------------------------------------------------------------------------*
  Project:  NITRO-System - demos - g3d - samples - PartialAnm1
  File:     main.c
...
// 2: NNS_G3dAnmObjDisableIDを用いて、再生しないジョイントを指定します。
//
//---------------------------------------------------------------------------
...
NitroMain(void)
{
    ...
    //
    {
        ...
        SDK_ASSERTMSG( pFile, "anm load failed" );
        {
            ...
            //
            // アニメーションオブジェクトを設定して左腕だけを動かすようにする。
            //
